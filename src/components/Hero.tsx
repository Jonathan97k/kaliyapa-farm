    ...
    <div className="relative min-h-screen lg:h-screen flex items-center justify-center overflow-hidden bg-charcoal">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <motion.div
          ...
          className="mb-10 inline-flex items-center space-x-3 px-5 py-2.5 rounded-full border border-white/15 bg-white/5 backdrop-blur-xl"
        >
          <span className="flex h-2 w-2 rounded-full bg-secondary animate-pulse" />
          <span className="text-white text-[10px] font-semibold tracking-[0.35em] uppercase">Sustainable Excellence in Malawi</span>
        </motion.div>
        ...
        <motion.div
           ...
           className="relative"
        >
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-serif font-bold mb-6 tracking-tight leading-[0.85] bg-gradient-to-r from-white via-secondary/90 to-white bg-clip-text text-transparent drop-shadow-[0_0_40px_rgba(201,162,39,0.3)]">
        ...
        <motion.div
          ...
          className="mb-14 max-w-3xl mx-auto p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10"
        >
          <p className="text-xl md:text-2xl font-light text-white/90 leading-relaxed italic font-serif text-center">
        ...
        >
          <Link to="/services" className="btn-premium flex items-center group">
            Explore Services
            <ArrowRight className="ml-3 h-4 w-4 group-hover:translate-x-1.5 transition-transform duration-300" />
          </Link>
          <Link to="/contact" className="btn-premium-outline !border-white/20 !text-white hover:!bg-white hover:!text-charcoal group">
            Get in Touch
          </Link>
        </motion.div>
      </div>
