...
import { CONTACT_PHONE, LOCATION } from '../constants';
...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Thank you for your inquiry. Our expertise team will contact you shortly.');
              ...
              <div>
                ...
                <div className="space-y-6 md:space-y-8">
                  {[
                    ...
                    { icon: Mail, label: "Digital Correspondence", value: "info@kaliyapafarmstead.com" },
              ...
              <form onSubmit={handleSubmit} className="space-y-6 md:space-y-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <input 
                       ...
                       className="w-full bg-cream/50 border border-transparent focus:border-secondary transition-all rounded-[1rem] md:rounded-[1.5rem] px-6 md:px-8 py-4 md:py-5 outline-none font-serif text-base md:text-lg text-primary placeholder:text-primary/20"
                    />
                  </div>
                  <div className="space-y-2 md:space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                  ...
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <select 
                      ...
                      className="w-full bg-cream/50 border border-transparent focus:border-secondary transition-all rounded-[1rem] md:rounded-[1.5rem] px-6 md:px-8 py-4 md:py-5 outline-none font-serif text-base md:text-lg text-primary appearance-none cursor-pointer"
                    >
                ...
                <div className="space-y-2 md:space-y-3">
                  ...
                  <textarea 
                     ...
                     className="w-full bg-cream/50 border border-transparent focus:border-secondary transition-all rounded-[1.5rem] md:rounded-[2rem] px-6 md:px-8 py-4 md:py-5 outline-none font-serif text-base md:text-lg text-primary placeholder:text-primary/20 resize-none"
                  ></textarea>
                </div>
